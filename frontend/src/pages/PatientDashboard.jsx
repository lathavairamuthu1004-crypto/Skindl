...
const PatientDashboard = () => {
  ...
  const [heatmapPos, setHeatmapPos] = useState({ t: '30%', l: '40%' });
  ...
  const analyzeSkin = async () => {
    ...
    // CNN UI Stages (Keep for UX/Animation)
    const stages = [
      { name: 'Uploading Image to AI Service...', delay: 800 },
      { name: 'Running TensorFlow CNN Inference...', delay: 1500, action: () => setShowHeatmap(true) },
      { name: 'Analyzing Pathological Markers...', delay: 1200 }
    ];
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setResult({
          ...
          severity: data.condition === "Melanoma" ? "Critical" : "Moderate",
          recommendation: data.condition === "Melanoma"
          ...
          riskLevel: data.condition === "Melanoma" ? "critical" : "medium"
        });
      }, currentDelay);
              ...
              {!image ? (
                ...
                >
                  ...
                  <div className="probability-map">
                    <h4>Softmax Output (Class Probabilities):</h4>
                    {result.allScores?.map(s => (
                      <div key={s.label} className="prob-row">
                        ...
                        <span className="p-value">{s.prob}%</span>
                      </div>
                    ))}
                  </div>
